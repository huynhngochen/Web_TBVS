...
<div id="wrapper">
      ...
      <div class="wp-content mt-4">
        	<div class="container">
        	<a href="admin/brand/index.htm" type="button" class="btn btn-outline-dark mr-3 float-left">Quay Lại</a>
        		<h3 class=" text-center">Bạn có chắc chắn muốn xóa danh mục? Vui lòng kiểm tra lại</h3>
        		<hr>
        		<p class="errors">${message}</p>
				<form:form action="admin/brand/delete.htm" method="post" modelAttribute="loaihang" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<form:input readonly="true" path="images" type="text" class="form-control"/>
					</div>
					<button class="btn btn-outline-success" >Xóa</button>
					<a href="admin/brand/index.htm" type="button" class="btn btn-outline-success mr-3">Hủy</a>
